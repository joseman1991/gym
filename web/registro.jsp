...
<html class="no-js">
    ...
    <body>	
        ...
        <div class="container col-lg-4 col-lg-offset-4">
            ...
            <form class="generic-blockquote" action="registrar" method="post">               
                <div class="mt-10">
                    <input type="text" name="nombre" placeholder="Nombres" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nombres'" required class="single-input" style="border:0.5px solid black">
                </div>                
                <div class="mt-10">
                    <input type="text" name="apellido" placeholder="Apellidos" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Apellidos'" required class="single-input" style="border:0.5px solid black">
                </div>                
                <div class="mt-10">
