...
<html class="no-js">
    ...
    <body>	
        ...
        <div class="container col-lg-4 col-lg-offset-4 mt-20">
            <h3 class="mb-30">Asignar entrenador</h3>
            ...
            <form class="generic-blockquote" action="setentrandor" method="post" id="abona">  
                <div class="mt-10">
                    <h5 class="mb-10">Selecciona entrenador</h5>
                    <div class="default-select mt-10" id="default-select" style="border:0.5px solid black; height: 45px">
                        <select class="single-input" name="identrenador">
                            <s:iterator value="listaUsuarios">
                                <option value="<s:property value="idusuario"/>"><s:property value="fullname"/></option>
                            </s:iterator>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <input type="submit" name="submit" class="genric-btn primary circle" value="Asignar"/>
