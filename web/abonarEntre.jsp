...
<html class="no-js">
    ...
    <body>	
        ...
        <div class="container col-lg-4 col-lg-offset-4 mt-20">
            ...
            <form class="generic-blockquote" action="abona2" method="post" id="abona">  
                <div class="mt-10">
                    <h5 class="mb-10">Completar pago</h5>
                    <input type="text"  value="<s:property value="precio"/>" readonly="" required class="single-input" style="border:0.5px solid black">
                </div>
                <div class="mt-10">
                    <h5 class="mb-10">Saldo</h5>
                    <input type="text" name="saldo" value="<s:property value="getText('{0,number,#,##0.00}',{saldo})"/>" readonly  class="single-input required" style="border:0.5px solid black">
                </div>
                
                <div class="mt-10">
                    <h5 class="mb-10">Abono *</h5>
                    <input type="text" name="abono" min="<s:property value="getText('{0,number,#,##0.00}',{0})"/>" max="<s:property value="getText('{0,number,#,##0.00}',{saldo})"/>" class="single-input required" style="border:0.5px solid black">
                </div>
                <br>
